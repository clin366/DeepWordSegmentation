...
class PosTagModel:
    def __init__(self, distinctTagNum, w2vPath, c2vPath, numHidden, embedding_word_size, embedding_char_size, max_sentence_len, max_chars_per_word, char_window_size):
        ...
        self.loss(np.zeros([1,self.max_sentence_len], dtype = int), np.zeros([1,self.max_sentence_len * self.max_chars_per_word], dtype = int), np.zeros([1,self.max_sentence_len], dtype = int))
